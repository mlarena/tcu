...
# Остановка служб
sudo systemctl stop burstroy-api.service
sudo systemctl stop burstroy-data.service
sudo systemctl stop burstroy-web.service
...
echo "Службы burstroy-api, burstroy-data и burstroy-web успешно обновлены и запущены в режиме разработки."
